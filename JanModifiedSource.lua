...
local library = {design = getgenv().design == "kali" and "kali", tabs = {}, draggable = true, flags = {}, title = "vamp-hub", open = false, mousestate = inputService.MouseIconEnabled,popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "awakenkn-hubv3", fileext = ".json"}
